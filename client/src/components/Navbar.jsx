      ...
      <div className="sm:flex hidden flex-row justify-end gap-4">
        ...
        <Link to="/profile">
          <div className="w-[52px] h-[52px] rounded-full bg-[#2c2f32] flex justify-center items-center cursor-pointer">
            <img src={stark} alt="user" className="w-[100%] h-[100%] object-contain rounded-[25px]" />
          </div>
        </Link>
      </div>
        ...
        >
          ...
          <div className="flex mx-4">
            <CustomButton
              ...
              styles={address ? 'bg-[#1dc071]' : 'bg-[#8c6dfd]'}
              handleClick={() => {
                if (address) handleCreateCampaign();
                else handleWalletConnection();
              }}
            />
          </div>
        </div>
...
//       <div className="flex flex-row items-center gap-4 w-full">
//         <h1 className="font-epilogue font-bold sm:text-[36px] text-[25px] leading-[38px] flex-shrink-0 mr-16 mt-2">
//           <span className="text-yellow-500">Stark</span><span className="text-blue-500">Raise</span>
//         </h1>
//         <div className="lg:flex-1 flex flex-row max-w-[458px] py-2 pl-4 pr-2 h-[52px] bg-[#1c1c24] rounded-[100px]">
//           <input
//             type="text"
